...
print(f"\n⚠️  Current database has {current_count} accommodations")
print(f"⚠️  Backup has {backup_data['total_rows']} accommodations")
print(f"⚠️  This will DELETE all current data and restore from backup!")
