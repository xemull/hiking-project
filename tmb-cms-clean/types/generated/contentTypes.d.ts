...
export interface ApiHikeHike extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    Elevation_gain: Schema.Attribute.Decimal;
...
export interface ApiTmbStageTmbStage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    elevation_gain: Schema.Attribute.Decimal;
    elevation_loss: Schema.Attribute.Decimal;
    end_location: Schema.Attribute.String;
    ...
    start_location: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
